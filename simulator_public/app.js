...
const THEME_STORAGE_KEY="dronez_simulator3_theme";
const droneTypes=[
...
const state={mode:"operations",camMode:"tower",selectedIdx:0,launched:false,day:getInitialDayTheme(),playing:false,
...
function applyTheme(){
  ...
  themeBtn.textContent=state.day?"🌙 Night":"☀ Day";
...
themeBtn.addEventListener("click",()=>{
  state.day=!state.day;
  try{localStorage.setItem(THEME_STORAGE_KEY,state.day?"day":"night");}catch{}
  applyTheme();
});
